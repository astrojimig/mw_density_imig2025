...
# Using Numba jit to compile these functions and run faster
...
def combined_exp_profile_nonsmoothed_linear(
    ...
    """Combined r,z profile for MW modeling. This is the main model used
    in the paper.
...
def radial_broken_exp(
    ...
    """Radially Broken Exponential for MW modeling. Used in the paper as the
    radial component of combined_exp_profile_nonsmoothed_linear()
...
def z_profile_linear(
    ...
    """Vertical linear-flaring profile for MW modeling. Used in the paper as
    the vertical component of combined_exp_profile_nonsmoothed_linear()
...
def radial_broken_exp_smoothed(
    ...
    """Smoothed Broken Exponential for MW modeling. Not used in the paper.
...
def z_profile_exp(
    ...
    """Single Vertical exponential for MW modeling. Not used in the paper.
...
def z_profile_flaring(
    ...
    """Vertical exponential with flaring for MW modeling. Not used in the
    paper.
    Inputs:
        h_z0: float: scale height
...
def combined_exp_profile_smoothed(
    ...
    """Smoothed combined r,z profile for MW modeling. Not used in the paper.
    Inputs:
        r_points: array: array of radii values to evaluate at (kpc)
        z_points: array: array of z values to evaluate at (kpc)
        hri: float: inner exponetial parameter
...
def combined_exp_profile_nonsmoothed(
    ...
    """Combined r,z profile for MW modeling. Not used in the paper.
    Inputs:
        r_points: array: array of radii values to evaluate at (kpc)
        z_points: array: array of z values to evaluate at (kpc)
        hri: float: inner exponetial parameter
